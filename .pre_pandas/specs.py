...
warm_up_file = "items/warm_up"  # assumes xlsx; warm_up_audio/warm_up
...
likert = [1, 2, 3, 4, 5, 6, 7]  # can also be used as forced choice
...
dynamic_fc = True
# values for the different kinds of answers (assumes that each column is a separate value); so if you have three different dynamic answer options, you would add their values below in the same order
dynamic_values = ["opt1", "opt2", "opt3"]
...
# item file
# assumes xlsx with suffix containing the number of the list: "complete_list1.xlsx")
item_lists = 2  # with 4, you should have four lists: $list1, $list2, $list3, $list4
item_file = "items/complete_dynamic"  # complete_list; complete_audio; complete_spr; complete_dynamic
items_randomize = False

# prefix for the results file
results_file = "results"
results_file_extension = ".csv"  # .dat, .txt, .csv
